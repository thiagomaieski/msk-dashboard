...
export default function AuthScreen() {
  const signInWithGoogle = useDash(s => s.signInWithGoogle);
    ...
    <div id="auth-screen">
      <div className="auth-card">
        <div className="auth-logo">
          <img src={logo} alt="Dashboard Maieski" className="logo-img" style={{ height: 40, marginRight: 10 }} />
        </div>
        <div className="auth-title">Bem-vindo de volta</div>
        <div className="auth-sub">Acesse seu painel de gestão de negócio e finanças</div>
